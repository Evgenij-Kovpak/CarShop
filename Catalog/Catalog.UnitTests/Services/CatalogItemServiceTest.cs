...
public class CatalogItemServiceTest
{
    ...
    public async Task AddAsync_Success()
    {
        ...
        // act
        var result = await _catalogService.Add(_testItem.Title, _testItem.Description, _testItem.PictureFileName, _testItem.Price, _testItem.AvailableStock, _testItem.CatalogBrandId, _testItem.CatalogSubCategoryId);
    ...
    public async Task UpdateAsync_Success()
    {
        ...
        // act
        var result = await _catalogService.Update(_testItem.Id, _testItem.Title, _testItem.Description, _testItem.PictureFileName, _testItem.Price, _testItem.AvailableStock, _testItem.CatalogBrandId, _testItem.CatalogSubCategoryId);
