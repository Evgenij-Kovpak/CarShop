...
public class CatalogItemRepository : ICatalogItemRepository
{
    ...
    public async Task<int?> AddAsync(string title, string description, string pictureFileName, decimal price, int availableStock, int catalogBrandId, int catalogSubCategoryId)
    {
