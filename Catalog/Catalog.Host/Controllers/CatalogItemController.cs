...
public class CatalogItemController : ControllerBase
{
    ...
    {
        var result = await _catalogItemService.Add(request.Title, request.Description, request.PictureFileName, request.Price, request.AvailableStock, request.CatalogBrandId, request.CatalogSubCategoryId);
    ...
    {
        var result = await _catalogItemService.Update(request.Id, request.Title, request.Description, request.PictureFileName, request.Price, request.AvailableStock, request.CatalogBrandId, request.CatalogSubCategoryId);
