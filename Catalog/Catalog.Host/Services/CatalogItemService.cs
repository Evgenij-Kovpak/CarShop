...
public class CatalogItemService : BaseDataService<ApplicationDbContext>, ICatalogItemService
{
    ...
    public Task<int?> Add(string title, string description, string pictureFileName, decimal price, int availableStock, int catalogBrandId, int catalogSubCategoryId)
    {
        return ExecuteSafeAsync(() => _catalogItemRepository.AddAsync(title, description, pictureFileName, price, availableStock, catalogBrandId, catalogSubCategoryId));
    }
    ...
    public Task<CatalogItemDto> Update(int id, string title, string description, string pictureFileName, decimal price, int availableStock, int catalogBrandId, int catalogSubCategoryId)
    {
